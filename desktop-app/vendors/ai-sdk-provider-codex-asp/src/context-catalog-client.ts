...
import type { FuzzyFileSearchResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/FuzzyFileSearchResponse";
import type { FuzzyFileSearchResult } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/FuzzyFileSearchResult";
import type { JsonValue } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/serde_json/JsonValue";
import type { AppInfo } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/AppInfo";
import type { AppsListResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/AppsListResponse";
import type { AppsReadParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/AppsReadParams";
import type { AppsReadResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/AppsReadResponse";
import type { ConfigBatchWriteParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/ConfigBatchWriteParams";
import type { ConfigReadResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/ConfigReadResponse";
import type { ConfigWriteResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/ConfigWriteResponse";
import type { ConnectorMetadata } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/ConnectorMetadata";
import type { FsReadFileParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/FsReadFileParams";
import type { FsReadFileResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/FsReadFileResponse";
import type { ListMcpServerStatusResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/ListMcpServerStatusResponse";
import type { MarketplaceAddParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/MarketplaceAddParams";
import type { MarketplaceAddResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/MarketplaceAddResponse";
import type { McpAuthStatus } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/McpAuthStatus";
import type { McpServerStatus } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/McpServerStatus";
import type { PluginDetail } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginDetail";
...
import type { PluginInstallParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginInstallParams";
import type { PluginInstallResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginInstallResponse";
import type { PluginListParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginListParams";
import type { PluginListResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginListResponse";
import type { PluginMarketplaceEntry } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginMarketplaceEntry";
import type { PluginReadResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginReadResponse";
import type { PluginSkillReadParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginSkillReadParams";
import type { PluginSkillReadResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginSkillReadResponse";
import type { PluginSummary } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginSummary";
import type { PluginUninstallParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginUninstallParams";
import type { PluginUninstallResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/PluginUninstallResponse";
import type { SkillMetadata } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/SkillMetadata";
import type { SkillsConfigWriteParams } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/SkillsConfigWriteParams";
import type { SkillsConfigWriteResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/SkillsConfigWriteResponse";
import type { SkillsListResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/SkillsListResponse";
import type { ThreadSearchResponse } from "@dascowork/codex-app-server-client/protocol/app-server-protocol/v2/ThreadSearchResponse";
