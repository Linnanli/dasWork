import type { AgentMessageDeltaNotification } from "../protocol/app-server-protocol/v2/AgentMessageDeltaNotification";
...
import type { ItemGuardianApprovalReviewCompletedNotification } from "../protocol/app-server-protocol/v2/ItemGuardianApprovalReviewCompletedNotification";
import type { ItemGuardianApprovalReviewStartedNotification } from "../protocol/app-server-protocol/v2/ItemGuardianApprovalReviewStartedNotification";
import type { ItemStartedNotification } from "../protocol/app-server-protocol/v2/ItemStartedNotification";
import type { McpToolCallProgressNotification } from "../protocol/app-server-protocol/v2/McpToolCallProgressNotification";
import type { ReasoningSummaryPartAddedNotification } from "../protocol/app-server-protocol/v2/ReasoningSummaryPartAddedNotification";
import type { ThreadTokenUsageUpdatedNotification } from "../protocol/app-server-protocol/v2/ThreadTokenUsageUpdatedNotification";
import type { TurnCompletedNotification } from "../protocol/app-server-protocol/v2/TurnCompletedNotification";
import type { TurnDiffUpdatedNotification } from "../protocol/app-server-protocol/v2/TurnDiffUpdatedNotification";
import type { TurnPlanUpdatedNotification } from "../protocol/app-server-protocol/v2/TurnPlanUpdatedNotification";
...
import type { CodexDynamicToolCallItem } from "../protocol/types";
import { turnErrorMessage } from "../turn-error";
import { stripUndefined } from "../utils/object";
import type { CodexRunEvent, CodexRunFinishReason, CodexRunUsage } from "./CodexRunEvent";
...
const EMPTY_USAGE: CodexRunUsage = {
    inputTokens: {
        total: undefined,
        noCache: undefined,
        cacheRead: undefined,
...
function toFinishReason(status: TurnStatus | undefined): CodexRunFinishReason
{
    switch (status)
    {
        case "completed":
...
function sourceItemIdForPart(part: CodexRunEvent): string | undefined
{
    switch (part.type)
    {
        case "text-start":
...
export class CodexEventMapper
{
   ...
   */
    ...
    private latestUsage: CodexRunUsage | undefined;

    private readonly handlers: Record<string, (params: unknown) => CodexRunEvent[]>;
   ...
   */
    ...
    map(event: CodexEventMapperInput): CodexRunEvent[]
    {
    ...
    private withMeta<T extends CodexRunEvent>(
        part: T,
    ...
    ): T
    {
        ...
        {
            return { ...part, metadata: { threadId: this.threadId, turnId: this.turnId, threadPath: this.threadPath, ...metadata } };
        }

        return { ...part, metadata: { threadId: this.threadId, turnId: this.turnId, ...metadata } };
    }

    private ensureStreamStarted(parts: CodexRunEvent[]): void
    {
    ...
    private emitReasoningDelta(parts: CodexRunEvent[], id: string, delta: string): void
    {
    ...
    // turn/started
    private handleTurnStarted(params: unknown): CodexRunEvent[]
    {
        ...
        const parts: CodexRunEvent[] = [];
        this.ensureStreamStarted(parts);
        return parts;
    }

    // item/started
    private handleItemStarted(params: unknown): CodexRunEvent[]
    {
    ...
    private handleAgentMessageDelta(params: unknown): CodexRunEvent[]
    {
    ...
    // item/completed
    private handleItemCompleted(params: unknown): CodexRunEvent[]
    {
    ...
    private handleReasoningDelta(params: unknown): CodexRunEvent[]
    {
    ...
    private handleSummaryPartAdded(params: unknown): CodexRunEvent[]
    {
    ...
    // turn/plan/updated
    private handlePlanUpdated(params: unknown): CodexRunEvent[]
    {
    ...
    // turn/diff/updated
    private handleTurnDiffUpdated(params: unknown): CodexRunEvent[]
    {
    ...
    private handleFileChangePatchUpdated(params: unknown): CodexRunEvent[]
    {
    ...
    private handleMcpToolCallProgress(params: unknown): CodexRunEvent[]
    {
    ...
    private handleAutoApprovalReviewStarted(params: unknown): CodexRunEvent[]
    {
    ...
    private handleAutoApprovalReviewCompleted(params: unknown): CodexRunEvent[]
    {
    ...
    private handleToolCallStarted(params: unknown): CodexRunEvent[]
    {
    ...
    // item/tool/callDelta
    private handleToolCallDelta(params: unknown): CodexRunEvent[]
    {
    ...
    private handleToolCallFinished(params: unknown): CodexRunEvent[]
    {
    ...
    // item/tool/call
    private handleToolCall(params: unknown): CodexRunEvent[]
    {
    ...
    private handleTokenUsageUpdated(params: unknown): CodexRunEvent[]
    {
    ...
    closeOpenToolCalls(reason: string): CodexRunEvent[]
    {
        const parts: CodexRunEvent[] = [];
    ...
    // turn/completed
    private handleTurnCompleted(params: unknown): CodexRunEvent[]
    {
        const parts: CodexRunEvent[] = [];
        this.ensureStreamStarted(parts);
...
/** Canonical AI-free name for the app-server event normalizer. */
export class CodexRunEventNormalizer extends CodexEventMapper {}
